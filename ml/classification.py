...
def train_stacked_model(preseason_games, X_train, X_test, y_train, y_test):
    ...
    # some grid search, some random search, so manual search arrived at these hyper-parameters
    grid = {
        ...
        #'feature_engineering__derived_stats__prune_garbage__threshold': [.007],
        ...
        'preprocessing2__skew__max_skew': [.75],
        ...
        'stacked_classification__meta-logisticregression__C': [.01],
